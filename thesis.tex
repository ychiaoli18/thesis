...
\renewcommand{\zhTitle}{使用查詢詞擴展與自動習得之聲學片段強化語音數位內容之語意檢索}  %中文標題
...
\chapter{以自動尋找之語音片段加強監督式語意檢索}
  \input{chapters/chapter3}
\chapter{以自動尋找之語音片段實現非監督式語意檢索}
  \input{chapters/chapter4}
\chapter{利用遞迴式類神經網路語言模型加強非監督式語音文件檢索}
  \input{chapters/chapter5}
\chapter{在Google Glass上實作個人化的語音辨識與新聞檢索系統}
