...
% Title Page
\renewcommand{\enTitle}{Reinforce Semantic Retrieval with Pseudo-Relevance Feedback and Acoustic Information}  %英文標題
\renewcommand{\zhTitle}{使用虛擬回饋與聲學資訊強化語義搜尋}  %中文標題
...
\renewcommand{\zhDepartmentName}{通訊工程學研究所}  %系所中文名稱
...
\renewcommand{\oralDate}{103 年 6 月 15 日}  %口試日期
...
\input{thesis_frontpages}

\chapter{導論}
  \input{chapters/chapter1}
\chapter{背景知識}
  \input{chapters/chapter2}
\chapter{以自動尋找之語音片段加強監督式語義搜尋}
  \input{chapters/chapter3}
\chapter{以自動尋找之語音片段實現無監督式語義搜尋}
  \input{chapters/chapter4}
\chapter{利用遞迴式類神經網路語言模型加強無監督式語義搜尋}
  \input{chapters/chapter5}
\chapter{在Google Glass上實作個人化的語音辨識與新聞搜尋系統}
