...
% Title Page
\renewcommand{\enTitle}{Question Answering System on Attention Memory Network}  %英文標題
\renewcommand{\zhTitle}{基於專注式記憶模型之問答系統}  %中文標題
...
\renewcommand{\zhDepartmentName}{電機工程學研究所}  %系所中文名稱
\renewcommand{\enDepartmentName}{Graduate Institute of Electrical Engineering}  %系所英文名稱
...
\chapter{根據專注式與記憶式遞迴神經網路實現選項式問答系統}
  \input{chapters/chapter3}
\chapter{以專注式記憶解碼器實現描述式問答系統}
